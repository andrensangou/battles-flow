...
import { SEO, SEO_DATA } from "@/components/SEO";
...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-black text-white graffiti-bg">
      {/* SEO dynamique basé sur l'onglet actif */}
      <SEO {...(SEO_DATA[activeTab as keyof typeof SEO_DATA] || SEO_DATA.home)} />
      {/* Hero Section */}
            ...
            <TabsContent value="youtube" className="space-y-6">
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-gray-400 text-sm">
                  Trouvez vos diss tracks préférés
                </p>
              </div>

              {/* Lecteur YouTube simple */}
              <SimpleYouTubePlayer className="max-w-4xl mx-auto" />
